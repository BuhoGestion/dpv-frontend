...
    // Quitamos el estado 'message' local ya que usaremos SweetAlert2
...
                showSweetAlert('error', 'Error de Carga', error.message || 'Error al cargar los datos del perfil.');
            } finally {
                setIsLoading(false);
            }
        };
...
        // setMessage(null); // Ya no es necesario
    };
...
                showSweetAlert('error', 'Error al Guardar', 'Error al guardar. Intente de nuevo.');
            }
        } catch (error) {
            // 💡 SweetAlert de error de la API o de conexión
            showSweetAlert('error', 'Error de Conexión', error.message || 'Error de conexión con el servidor.');
        } finally {
            setIsSaving(false);
        }
    };
...
            if (result.success) {
                // 💡 SweetAlert de éxito
                showSweetAlert('success', '¡Contraseña Actualizada!', result.message);
                // Limpiar campos al éxito
                setPassword({ actual: '', nueva: '', confirmar: '' }); 
            }
        } catch (error) {
            // 💡 SweetAlert de error de la API o de validación
            showSweetAlert('error', 'Error al Cambiar Contraseña', error.message || 'Error al cambiar la contraseña.');
        } finally {

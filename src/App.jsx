...
function App() {
  ...
  }, [isAuthenticated]); // Componente central que pasa el nombre de usuario y el logout (Mantenido)
    ...
    <BrowserRouter key={authKey}>
      <Routes>
        ...
        <Route
          ...
          element={
            <PermissionRoute
              requiredPermissions={["OBRAS_VER", "OBRAS_EDITAR"]}
            >
              <Layout>
                <Obras />
              </Layout>
        ...
        <Route
          path="/usuarios"
          element={
            <PermissionRoute requiredPermissions={["FULL_ADMIN"]}>
              <Layout>
                <User />
              </Layout>
            </PermissionRoute>
